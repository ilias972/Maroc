...
class Auth {
    ...
    public function login($username, $password) {
        ...
        // Pour le moment, on l'affiche (développement uniquement)

        return [
            'success' => true,
            'require_2fa' => true,
            'code_2fa' => $code_2fa, // DÉVELOPPEMENT UNIQUEMENT
    ...
    public function changePassword($user_id, $old_password, $new_password) {
        ...
        // Valider le nouveau mot de passe (minimum 8 caractères, 1 majuscule, 1 chiffre)
    ...
    public function isBlocked($ip_address) {
        ...
        return $attempts >= 5; // 5 tentatives max en 15 minutes
    }
